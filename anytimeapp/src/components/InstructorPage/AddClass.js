...
export default function AddClass(props) {
  ...
  return (
    <>
      <h2 className="mt-6 mb-4 text-3xl font-extrabold text-center text-gray-900">Create a New Class</h2>
      <form onSubmit={classFormSubmit}>
        <div className="w-1/3 mx-auto -space-y-px rounded-md shadow-sm isolate">
          <div className="relative px-3 py-2 border border-gray-300 rounded-md rounded-b-none focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
            ...
            <input
              ...
              id="theClassName"
              className="block p-0 text-gray-900 placeholder-gray-500 border-0 focus:ring-0 sm:text-sm"
